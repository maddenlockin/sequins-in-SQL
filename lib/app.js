...
app.post('/specialties', async(req, res) => {
  try {
    const data = await client.query(
      `INSERT INTO specialties (type, focus, difficulty, owner_id)
      VALUES ($1, $2, $3, 1)
      RETURNING *`, [req.body.type, req.body.focus, req.body.difficulty]);
...
app.put('/specialties/:id', async(req, res) => {
  try {
    const data = await client.query(`
      ...
      where id=$4
      returning *
      `, [req.body.type, req.body.focus, req.body.difficulty, req.params.id]);
